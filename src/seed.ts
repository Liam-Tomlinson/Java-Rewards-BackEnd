...
export const populateTestData = async () => {
  ...
  console.log(`Seeding database ${db.databaseName} , collection ${shops.collectionName}...`)
  await shops.insertMany(shopData)
  console.log(`Seeding database ${db.databaseName} , collection ${users.collectionName}...`)
  await users.insertMany(userData)
  console.log(`Seeding database ${db.databaseName} , collection ${orders.collectionName}...`)
  await users.insertMany(ordersData)
